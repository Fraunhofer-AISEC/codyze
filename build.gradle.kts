...
sourceSets.configureEach {
    ...
    // add classes that are generated by the sarif parser
    resources.srcDir("build/generated/sources/js2d")
}
...
// state that JSON schema parser must run before compiling Kotlin or initializing tests
