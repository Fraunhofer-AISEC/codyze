...
public class SimpleArgument {
    ...
    // Ok even though we do not use a CallExpression to initialize
    public void overwrite2Ok() {
        Foo f = new Foo();
        Bar b = new Bar();
    ...
    // Should fail even though we do not use a CallExpression to overwrite
