...
class FindSecBugsExecutorTest : CompiledExecutorTest() {
    override val executor = FindSecBugsExecutor()
    override val resultFileName = "findsecbugs.sarif"
    override val expectedResults = SpotbugsExecutorTest().expectedResults + listOf(
        Result(
