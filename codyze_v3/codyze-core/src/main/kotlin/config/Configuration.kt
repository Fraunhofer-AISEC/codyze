 ...
 * 4. make sure to set a default value for the new CLI option that is not [null]. Options that might
 * be [null] can cause issues with the map delegate used in the factory methods.
 ...
 *
 * You should pretty much always only use the normalized [Configuration] to run Codyze. Otherwise,
 * some settings might contradict each other.
 */
