...
[:fontawesome-solid-arrow-up-right-from-square: `Ops`](../../api/codyze/codyze-specification-languages/coko/coko-core/de.fraunhofer.aisec.codyze.specificationLanguages.coko.core.dsl/-op){target=_blank} are the basic building blocks for writing policies in Coko.
...
The function [:fontawesome-solid-arrow-up-right-from-square: `op()`](../../api/codyze/codyze-specification-languages/coko/coko-core/de.fraunhofer.aisec.codyze.specificationLanguages.coko.core.dsl/op.html){target=_blank} is the start for building `FunctionOps`.
...
The function of the builder for `ConstructorOps` is [:fontawesome-solid-arrow-up-right-from-square: `constructor()`](../../api/codyze/codyze-specification-languages/coko/coko-core/de.fraunhofer.aisec.codyze.specificationLanguages.coko.core.dsl/constructor.html){target=_blank}.
