...
| Legacy Codyze           | Redesigned Codyze       | Value               | Description                                                                                                                                                                                                                                               | Default Value     |
|:------------------------|:------------------------|:--------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------|
...
| sarif                   |                         | boolean             | Controls whether the output is written in the SARIF format. __Deprecated__ because output is only written in SARIF format.                                                                                                                                | true              |
...
|                         | executor                | String              | Manually choose Executor to use with the given spec files. If unspecified, Codyze randomly selects an executor capable of evaluating the given specification files. __New__.                                                                              | randomly selected |
...
|                         | match-comments-to-nodes | boolean             | Controls whether the CPG frontend shall use a heuristic matching of comments found in the source file to match them to the closest AST node and save it in the comment property. __New__.                                                                 | false             |
