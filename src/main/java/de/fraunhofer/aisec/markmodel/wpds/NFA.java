...
public class NFA {
  ...
  /**
   * Factory method to create a new NFA from a Mark "order" expression (effectively a regular
   * expression).
   *
   * @param seq
   * @return
  ...
  /**
   * Initially, the NFA consists only of states (=Nodes), connected by "successor" edges. We make
   * these transitions explicit in a "transitions" set.
   */
