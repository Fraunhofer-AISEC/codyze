...
internal class MarkCppTest : AbstractMarkTest() {
    ...
    fun nested_markvars() {
        val findings =
            performTest("mark_cpp/nested_markvars.cpp", arrayOf("mark_cpp/nested_markvars.mark"))
    ...
    fun functioncall() {
        val findings =
            performTest("mark_cpp/functioncall.cpp", arrayOf("mark_cpp/functioncall.mark"))
        expected(
            findings,
    ...
    fun testNewExpression() {
        val findings = performTest("mark_cpp/new.cpp", arrayOf("mark_cpp/new.mark"))
    ...
    fun functioncallComplex() {
        val findings =
            performTest(
                "mark_cpp/functioncall_complex.cpp",
                arrayOf("mark_cpp/functioncall_complex.mark")
            )
        expected(
            findings,
    ...
    @Throws(Exception::class)
    fun _01_assign() {
        val findings = performTest("mark_cpp/01_assign.cpp", arrayOf("mark_cpp/01_assign.mark"))
    ...
    @Throws(Exception::class)
    fun _02_arg() {
        val findings = performTest("mark_cpp/02_arg.cpp", arrayOf("mark_cpp/02_arg.mark"))
        expected(
            findings,
    ...
    fun _03_arg_as_param() {
        val findings =
            performTest("mark_cpp/03_arg_as_param.cpp", arrayOf("mark_cpp/03_arg_as_param.mark"))
        println("All findings:")
        for (f in findings) {
            println(f.toString())
        }
    ...
    fun arg_prevassign_int() {
        val findings = performTest("mark_cpp/arg_prevassign_int.cpp", arrayOf("mark_cpp/int.mark"))
    ...
    fun arg_prevassign_bool() {
        val findings =
            performTest("mark_cpp/arg_prevassign_bool.cpp", arrayOf("mark_cpp/bool.mark"))
    ...
    fun arg_prevassign_string() {
        val findings =
            performTest("mark_cpp/arg_prevassign_string.cpp", arrayOf("mark_cpp/string.mark"))
    ...
    @Throws(Exception::class)
    fun arg_vardecl_int() {
        val findings = performTest("mark_cpp/arg_vardecl_int.cpp", arrayOf("mark_cpp/int.mark"))
    ...
    fun arg_vardecl_bool() {
        val findings = performTest("mark_cpp/arg_vardecl_bool.cpp", arrayOf("mark_cpp/bool.mark"))
        expected(findings, "line 12: Rule SomethingAboutFoo verified")
    }
    ...
    fun arg_vardecl_string() {
        val findings =
            performTest("mark_cpp/arg_vardecl_string.cpp", arrayOf("mark_cpp/string.mark"))
    ...
    fun arg_assignconstructor_int() {
        val findings =
            performTest("mark_cpp/arg_assignconstructor_int.cpp", arrayOf("mark_cpp/int.mark"))
    ...
    fun arg_assignparenthesisexpr_int() {
        val findings =
            performTest("mark_cpp/arg_assignparenthesisexpr_int.cpp", arrayOf("mark_cpp/int.mark"))
        println("All findings:")
        for (f in findings) {
            println(f.toString())
        }
    ...
    fun arg_initializerparenthesisexpr_int() {
        val findings =
            performTest(
                "mark_cpp/arg_initializerparenthesisexpr_int.cpp",
                arrayOf("mark_cpp/int.mark")
            )
    ...
    fun arg_uniforminitializer_int() {
        val findings =
            performTest("mark_cpp/arg_uniforminitializer_int.cpp", arrayOf("mark_cpp/int.mark"))
        expected(findings, "line 16: Rule SomethingAboutFoo verified")
    }
    ...
    @Throws(Exception::class)
    fun const_value() {
        val findings = performTest("mark_cpp/const.cpp", arrayOf("mark_cpp/const.mark"))
