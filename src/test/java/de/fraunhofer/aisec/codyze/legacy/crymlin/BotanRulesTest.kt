...
internal class BotanRulesTest : AbstractMarkTest() {
    ...
    fun test_rule_2_01() {
        val findings = performTest("legacy/botan_rule_tr_test/2_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_2_1_01() {
        val findings = performTest("legacy/botan_rule_tr_test/2_1_01.cpp", "mark/botan/")
        expected(
            findings,
            "line 15: Rule _2_01_BlockCiphers verified", // ok
            "line 15: Rule _2_1_01_Modes verified", // ok
    ...
    fun test_rule_2_1_2_1_02() {
        val findings = performTest("legacy/botan_rule_tr_test/2_1_2_1_02.cpp", "mark/botan/")
        expected(
            findings,
            "line 15: Rule _2_01_BlockCiphers verified", // ok
            "line 21: Violation against Order: rng.random_vec(enc->default_nonce_length()) (get_random) is not allowed. Expected one of: r.create (RNGOrder)", // default ctor-problem in CPG
    ...
    fun test_rule_2_1_2_2_03() {
        val findings = performTest("legacy/botan_rule_tr_test/2_1_2_2_03.cpp", "mark/botan/")
        expected(
            findings,
            "line 15: Rule _2_01_BlockCiphers verified", // ok
            "line 21: Violation against Order: rng.random_vec(enc->default_nonce_length()) (get_random) is not allowed. Expected one of: r.create (RNGOrder)", // default ctor-problem in CPG
    ...
    fun test_rule_2_1_2_3_01() {
        val findings = performTest("legacy/botan_rule_tr_test/2_1_2_3_01.cpp", "mark/botan/")
    ...
    fun test_rule_3_3_02() {
        val findings = performTest("legacy/botan_rule_tr_test/3_3_02.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_3_3_03() {
        val findings = performTest("legacy/botan_rule_tr_test/3_3_03.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_3_4_01() {
        val findings = performTest("legacy/botan_rule_tr_test/3_4_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_3_4_02() {
        val findings = performTest("legacy/botan_rule_tr_test/3_4_02.cpp", "mark/botan/")
        expected(
            findings,
    ...
    @Throws(Exception::class)
    fun test_rule_4_01() {
        val findings = performTest("legacy/botan_rule_tr_test/4_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_3_01() {
        val findings = performTest("legacy/botan_rule_tr_test/5_3_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_3_02() {
        val findings = performTest("legacy/botan_rule_tr_test/5_3_02.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_3_03() {
        val findings = performTest("legacy/botan_rule_tr_test/5_3_03.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_4_1_01() {
        val findings = performTest("legacy/botan_rule_tr_test/5_4_1_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_4_1_02() {
        val findings = performTest("legacy/botan_rule_tr_test/5_4_1_02.cpp", "mark/botan/")
        expected(
            findings,
            "line 11: Rule _5_4_1_02_RSA_SIG_KeyLen_2022 verified", // ok
            "line 11: Rule _5_4_1_02_RSA_SIG_KeyLen verified", // ok
    ...
    fun test_rule_5_4_2_01() {
        val findings = performTest("legacy/botan_rule_tr_test/5_4_2_01.cpp", "mark/botan/")
        expected(
            findings,
    ...
    fun test_rule_5_4_3_01() {
        val findings = performTest("legacy/botan_rule_tr_test/5_4_3_01.cpp", "mark/botan/")
        expected(
            findings,
            "line 14: Verified Order: SignatureOrder", // ok
            "line 13: Verified Order: PrivKeyOrder", // ok
    ...
    fun test_rule_7_2_2_1_01() {
        val findings = performTest("legacy/botan_rule_tr_test/7_2_2_1_01.cpp", "mark/botan/")
        containsFindings(
            findings,
