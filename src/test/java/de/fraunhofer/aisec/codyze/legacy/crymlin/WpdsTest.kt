...
import de.fraunhofer.aisec.codyze.legacy.analysis.wpds.NFA
...
internal class WpdsTest : AbstractMarkTest() {
    ...
    fun testCppRegression88() {
        val findings = performTest("legacy/unittests/regression88.cpp", "../../src/dist/mark/botan")
    ...
    fun testJavaMethodArgs() {
        val findings =
            performTest("legacy/java/jca/AESCBC.java", "../../src/dist/mark/bouncycastle")
        val startLineNumbers =
            findings
                .stream()
                .collect(
