...
public class BotanRuleTR_Test extends AbstractMarkTest {
	...
	public void test_rule_2_01() throws Exception {
		...
		expected(findings,
			"line 15: MarkRuleEvaluationFinding: Rule _2_01_BlockCiphers verified", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_1_01_Modes verified", // ok
			...
			"line 15: MarkRuleEvaluationFinding: Rule _2_01_KeyLength violated" // ok
	...
	public void test_rule_2_1_2_1_02() throws Exception {
		...
		expected(findings,
			...
			"line 21: Violation against Order: enc->start(rng.random_vec(enc->default_nonce_length())); (start_iv) is not allowed. Expected one of: cm.set_key (Cipher_Mode_Order)", // ok
			"line 15: Violation against Order: Base enc is not correctly terminated. Expected one of [cm.set_key] to follow the correct last call on this base. (Cipher_Mode_Order)", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_1_01_Modes violated", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_01_KeyLength violated", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_1_2_1_02_CCM_TagSize verified" // ok
		);
	...
	public void test_rule_2_1_2_2_03() throws Exception {
		...
		expected(findings,
			...
			"line 15: MarkRuleEvaluationFinding: Rule _2_1_01_Modes violated", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_01_KeyLength violated", // ok
			"line 15: MarkRuleEvaluationFinding: Rule _2_1_2_2_03_GCM_TagSize verified" // ok
		);
	}
	...
	public void test_rule_3_3_02() throws Exception {
		...
		expected(findings,
			"line 21: MarkRuleEvaluationFinding: Rule _3_3_03_ECIES_KDF verified", // ok
			"line 17: MarkRuleEvaluationFinding: Rule _3_3_02_CurveParams verified", // ok
	...
	public void test_rule_3_3_03() throws Exception {
		...
		expected(findings,
			"line 22: MarkRuleEvaluationFinding: Rule _3_3_03_ECIES_KDF verified", // ok
			"line 18: MarkRuleEvaluationFinding: Rule _3_3_02_CurveParams verified", // ok
	...
	public void test_rule_3_4_01() throws Exception {
		...
		expected(findings,
			...
			"line 27: MarkRuleEvaluationFinding: Rule _3_4_01_DLIES_KDF verified", // ok
			"line 19: MarkRuleEvaluationFinding: Rule _3_4_02_DLIES_KEYLEN_2022 verified", // ok
			"line 22: Verified Order: PubKeyOrder",
			"line 21: Verified Order: PrivKeyOrder",
			"line 19: MarkRuleEvaluationFinding: Rule _3_4_02_DLIES_KEYLEN verified", // ok
			"line 30: MarkRuleEvaluationFinding: Rule _5_3_01_MAC verified", // ok
			"line 19: MarkRuleEvaluationFinding: Rule _7_2_2_1_01_DH_KEYLEN_2022 verified", // ok
			"line 19: MarkRuleEvaluationFinding: Rule _7_2_2_1_01_DH_KEYLEN verified" // ok
		);
	}
	...
	public void test_rule_4_01() throws Exception {
		...
		expected(findings,
			...
			"line 8: MarkRuleEvaluationFinding: Rule _4_01_HashFunctions violated", // ok
			"line 9: MarkRuleEvaluationFinding: Rule _4_01_HashFunctions violated", // ok
			"line 10: MarkRuleEvaluationFinding: Rule _4_01_HashFunctions verified" // ok
		);
	}
	...
	public void test_rule_5_3_02() throws Exception {
		...
		expected(findings, "line 11: MarkRuleEvaluationFinding: Rule _5_3_02_MAC_KEYLEN verified", // ok
			"line 14: MarkRuleEvaluationFinding: Rule _5_3_01_MAC verified", // ok
	...
	public void test_rule_5_3_03() throws Exception {
		...
		expected(findings,
			"line 12: MarkRuleEvaluationFinding: Rule _5_3_02_MAC_KEYLEN verified", // ok
			"line 20: MarkRuleEvaluationFinding: Rule _5_3_03_MAC_NONCELEN verified", // ok
			"line 16: MarkRuleEvaluationFinding: Rule _5_3_01_MAC verified", // ok
	...
	public void test_rule_5_4_3_01() throws Exception {
		...
		expected(findings,
			"line 14: Verified Order: SignatureOrder", // ok
			"line 13: Verified Order: PrivKeyOrder", // ok
			"line 14: MarkRuleEvaluationFinding: Rule _5_4_3_01_ECDSA_SIG verified" // ok
		);
	}
	...
	public void test_rule_7_2_2_1_01() throws Exception {
		...
		expected(findings,
			"line 13: MarkRuleEvaluationFinding: Rule _7_2_2_1_01_DH_KEYLEN verified", // ok
			"line 13: MarkRuleEvaluationFinding: Rule _7_2_2_1_01_DH_KEYLEN_2022 verified"); // ok
	}
